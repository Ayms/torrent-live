  ...
  function onResponse (err, res) {
    ...
    if (pending === 0 && candidates.length === 0) {
      ...
      closest.forEach(function (contact) {
		...
		//console.log((opts?(opts.findNode?'find_node closest':'get_peers closest'):'get_peers closest')+' '+contact.addr + ' ' + idToHexString(contact.id)+' for '+idToHexString(id));
      })
